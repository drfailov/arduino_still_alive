...
const int sdinPin = 51;//11  // DN(MOSI) - Serial data, pin 6 on LCD.
const int sclkPin = 52;//13  // SCLK - Serial clock, pin 7 on LCD.
const int blPin = 9;//9    // LED - Backlight LED, pin 8 on LCD.
